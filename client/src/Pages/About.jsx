    ...
    return (
        <div >
            ...
            <div className="bg-[#ADCF5B33] z-50 relative  pt-4 px-8 flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="w-full md:w-2/3 lg:w-[630px] xl:pl-18 lg:pl-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 pt-4 pb-16 md:w-[450px]">
                        <div className="border-[#3D864B] border-1 w-auto h-auto lg:w-[230px] lg:h-[210px] rounded-lg p-4 shadow-sm">
                            <img src={i4} alt={"hii"} className="w-8 h-8  mb-2" />
                        ...
                        <div className="border-[#3D864B] border-1 w-auto h-auto lg:w-[230px] lg:h-[210px] rounded-lg p-4 shadow-sm">
                            <img src={i5} alt={"hii"} className="w-8 h-8  mb-2" />
                            <h3 className="text-[#3d864b] font-urbanist-bold mb-2">
                        ...
                        <div className="border-[#3D864B] border-1 w-auto h-auto lg:w-[230px] lg:h-[210px] rounded-lg p-4 shadow-sm">
                            <img src={i6} alt={"hii"} className="w-8 h-8  mb-2" />
                            <h3 className="text-[#3d864b] font-urbanist-bold mb-2">
                        ...
                        <div className="border-[#3D864B] border-1 w-auto h-auto lg:w-[230px] lg:h-[210px] rounded-lg p-4 shadow-sm">
                            <img src={i7} alt={"hii"} className="w-8 h-8  mb-2" />
                            <h3 className="text-[#3d864b] font-urbanist-bold mb-2">
                                Here For You, Always
                            </h3>
                            <p className="text-sm text-gray-600 font-urbanist-regular leading-[120%]">
                ...
                <div className="w-full md:w-1/3 mt-8 md:mt-0 flex justify-center">
                    <div className="relative xl:pr-30 w-100 lg:pt-4 md:h-[650px] lg:h-[750px]">
                ...
                <img
                    ...
                    alt="Background shape"
                    className="object-contain w-[20%] h-full absolute opacity-100 left-[80%]"
                />
            </div>
