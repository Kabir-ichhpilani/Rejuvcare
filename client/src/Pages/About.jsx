        ...
        <div className="font-['Urbanist']">
            ...
            <div className="w-full px-4 md:px-6 lg:px-8 xl:px-16">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pt-20 pb-16 relative">
                        {/* Text Content */}
                        <div className="space-y-6 z-20 pt-8 w-full lg:max-w-2xl">
                            ...
                            <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[55px] leading-tight lg:leading-[80px]">
                                Welcome To The<br/> <span className="text-[#47A66E]">Revitalizing</span> Side Of Care
                            </h1>
                            <p className="text-gray-700 text-base sm:text-lg md:text-xl lg:text-[22px] leading-relaxed lg:leading-[33px]">
                                At Rejuvcare, we believe in more than just care – we believe in empowering lives. Bringing warmth,
                                dignity, and compassion to every step of your journey towards independence and vitality.
                            </p>
                            <a
                                href="#contact"
                                className="inline-block bg-[#47A66E] text-white px-6 md:px-8 py-3 rounded-lg hover:bg-[#3d8f5d] transition-colors"
                            >
                                Contact Us
                            </a>
                        </div>
                        ...
                        <div className="relative w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[600px] xl:h-[700px]">
                            {/* Background shape */}
                            <div className="absolute -top-6 lg:top-2 left-4 sm:left-8 md:left-12 lg:left-10 xl: w-full md:w-[300px] lg:w-[400px] xl:left-16 pr-10 xl:w-[550px] h-full">
                                <img
                                    src={img1}
            ...
            <div className="w-full bg-[#ADCF5B1A] px-4 md:px-6 lg:px-8 xl:px-16">
                <div className="max-w-3xl mx-auto py-12 md:py-16 text-center space-y-6 md:space-y-8">
                    <p className="text-lg">Our Motto</p>
                    <h2 className="font-bold text-3xl md:text-4xl lg:text-5xl">
                        Genuine Care Knows <span className="text-[#47A66E] block mt-2">No Limits</span>
                    </h2>
            ...
            <div className="relative pt-16 pb-20">
                ...
                <div className="relative z-10 text-center">
                    ...
                    <p className="text-3xl md:text-4xl font-medium">
                        Transforming the way <span className="text-[#47A66E]">We Care</span>
                    </p>
                </div>
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 justify-center items-center mt-10">
                    ...
                    <div className="flex flex-col items-center text-center w-auto lg:w-[280px] max-w-xs mx-auto space-y-4">
                        ...
                        <h3 className="text-xl md:text-2xl font-medium">Personalized Care Solutions</h3>
                    ...
                    <div className="flex flex-col items-center text-center w-auto lg:w-[280px] max-w-xs mx-auto space-y-4">
                        ...
                        <h3 className="text-xl md:text-2xl font-medium">Compassionate and Trusted Care</h3>
                        <p className="text-gray-600 max-w-sm mx-auto">
                    ...
                    <div className="flex flex-col items-center text-center w-auto lg:w-[280px] max-w-xs mx-auto space-y-4">
                        ...
                        <h3 className="text-xl md:text-2xl font-medium">Holistic Health and Well-Being</h3>
                        <p className="text-gray-600 max-w-sm mx-auto">
...
t
                <div className="w-full md:w-2/3 lg:w-[550px] space-y-6">
                    <h1 className="text-4xl font-semibold leading-tight">
                        ...
                        <span className="text-emerald-600">Rejuvenation</span> And Empowerment.
                    </h1>


                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 pb-16 md:w-[450px]">
                        <div className="border-[#3D864B] border-2 w-auto h-auto lg:w-[210px] lg:h-[220px] rounded-lg p-4 shadow-sm">
                            <User2 className="w-6 h-6 text-emerald-600 mb-2" />
                            <h3 className="text-emerald-600 font-medium mb-2">
            ...
            <div className="flex justify-center items-center py-16 px-4 text-center">
                ...
                <div className="max-w-3xl">
                    <h1 className="text-3xl md:text-4xl leading-relaxed font-light">
                        At Rejuvcare, we're dedicated to{' '}
                        <span className="inline-block bg-emerald-600 text-white px-3 py-1 rounded-md">
            empowering lives
          </span>
                        {' '}with compassionate care, fostering health,{' '}
                        <span className="inline-block bg-emerald-600 text-white px-3 py-1 rounded-md">
            independence,
          </span>
